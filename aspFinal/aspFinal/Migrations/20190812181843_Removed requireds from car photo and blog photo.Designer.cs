...
namespace aspFinal.Migrations
{
    ...
    [Migration("20190812181843_Removed requireds from car photo and blog photo")]
    partial class Removedrequiredsfromcarphotoandblogphoto
    {
            ...
            modelBuilder.Entity("aspFinal.Models.Advertisement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CarId = 1, CityId = 1, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 205, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 2, CarId = 2, CityId = 1, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 3, CarId = 3, CityId = 2, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 4, CarId = 4, CityId = 3, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 5, CarId = 5, CityId = 4, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 6, CarId = 6, CityId = 5, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 7, CarId = 7, CityId = 6, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) },
                        new { Id = 8, CarId = 8, CityId = 3, CurrentDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 12, 22, 18, 43, 206, DateTimeKind.Local) }
                    );
                });
