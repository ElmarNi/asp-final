...
namespace aspFinal.Migrations
{
    ...
    [Migration("20190814134557_Added cardetailimages")]
    partial class Addedcardetailimages
    {
            ...
            modelBuilder.Entity("aspFinal.Models.Advertisement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 1, CityId = 1, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 695, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 2, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 2, CityId = 1, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 3, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 3, CityId = 2, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 4, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 4, CityId = 3, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 5, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 5, CityId = 4, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 6, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 6, CityId = 5, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 7, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 7, CityId = 6, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 8, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 8, CityId = 3, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) },
                        new { Id = 9, ApplicationUserId = "6f7d0122-db19-4071-941f-57792706dbe0", CarId = 9, CityId = 3, CurrentDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local), UpdatedDate = new DateTime(2019, 8, 14, 17, 45, 56, 696, DateTimeKind.Local) }
                    );
                });
