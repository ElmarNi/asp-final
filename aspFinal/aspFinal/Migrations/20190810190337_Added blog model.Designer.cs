...
namespace aspFinal.Migrations
{
    ...
    [Migration("20190810190337_Added blog model")]
    partial class Addedblogmodel
    {
            ...
            modelBuilder.Entity("aspFinal.Models.Advertisement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CarId = 1, CityId = 1, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 2, CarId = 2, CityId = 1, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 3, CarId = 3, CityId = 2, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 4, CarId = 4, CityId = 3, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 5, CarId = 5, CityId = 4, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 6, CarId = 6, CityId = 5, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 7, CarId = 7, CityId = 6, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 8, CarId = 8, CityId = 3, CurrentDate = new DateTime(2019, 8, 10, 23, 3, 37, 513, DateTimeKind.Local), UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });
